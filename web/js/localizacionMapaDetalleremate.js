  ...
  var coord_remate = $( '#map_detalleremate' ).data( 'coord');
...
var styles = [
  ...
  },
  {
    ...
    separador = ",";
    limite    = 2;
    cadena = coord_remate.split(separador, limite);
    var lat = cadena[0];
    var log = cadena[1];
    console.log(lat);
    console.log(log);
    ...
    map4 = new google.maps.Map(document.getElementById("map_detalleremate"), myOptions);
