...
<div class="panel panel-default" role="menu" data-wow-duration="0.8s" data-wow-delay="0s">
      <div class="panel-heading text-left"><?= Html::encode($this->title) ?> 
        ...
        <?= Html::a('<i class="fa fa-plus"></i>', '#', [
            ...
            'title' => Yii::t('app', 'Crear Barrio'),
            'data-toggle' => 'modal',
            'data-target' => '#modal',
            'data-url' => Url::to(['create']),
            'data-pjax' => '0',
        ]); ?>
       <!--  <a href="<?php #Url::to(['barrio/create']) ?>" class="btn-link btn-sm"><i class="fa fa-plus"></i></a> -->
      </div>
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value'=> function($model){
                            $dpto = Departamento::findOne($model->id_departamento);
                            return $dpto->nombre;  
                        }, 
                    ...
                    [
                        'attribute'=>'id_ciudad',
                        'value'=> function($model){
                            $ciudad = Ciudad::findOne($model->id_ciudad);
                            return $ciudad->nombre;  
                        }, 
                        'filter'=> ArrayHelper::map(Ciudad::find()->all(),'id','nombre'),
                            //'attribute' => 'id_barrio',
                            //'value' => 'idBarrio.nombre',
                    ],
                    'nombre',
                        ...
                        'buttons' => [
                            'update' => function ($url, $model, $key) {
                                return Html::a('<span class="glyphicon glyphicon-pencil"></span>', '#', [
                                    'id' => 'activity-index-link',
                                    'title' => Yii::t('app', 'Modificar Barrio'),
                                    'data-toggle' => 'modal',
                                    'data-target' => '#modal',
